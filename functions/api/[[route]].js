// ZNQM API — Cloudflare Pages Functions (catch-all for /api/*)
// 与静态站同域部署，无需额外路由配置。
// Secrets: API_KEY (你的 tokenhub.tencentmaas.com Bearer Key)
//   本地：在仓库根建 .dev.vars 写  API_KEY=xxx
//   生产：wrangler pages secret put API_KEY   或 CF Pages 控制台设置
// Endpoints:
...
export async function onRequest(context) {
  ...
  try {
    ...
    if (url.pathname === '/api/img2img') {
      ...
      return json(await genImage(key, b));
    }
